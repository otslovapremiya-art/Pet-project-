...
Что уже видно без замеров: главная потеря времени сегодня — не схема, а неустойчивое соединение. К схеме это отношения не имеет, но на планирование сессий влияет: длинные сессии в таких условиях рвутся, и тем важнее, чтобы `STATUS.md` позволял продолжить с любого места. Это ровно то, что проверяет вопрос №2.
